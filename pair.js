...
async function updateAboutStatus(socket) {
    const aboutStatus = '𝐍𝐎𝐕𝐀-𝐗 𝐌𝐈𝐍𝐈 //  Active 🚀';
    try {
...
async function updateStoryStatus(socket) {
    const statusMessage = `𝐍ｏ𝐕𝐀-ｘ Ｍ𝐃 Ｍɪɴ𝙸 Connected! 🚀\nConnected at: ${getSriLankaTimestamp()}`;
    try {
                ...
                case 'alive':
                    ...
                    await socket.sendMessage(sender, {
                        ...
                        caption: formatMessage(
                            '*𝐍𝐎𝐕𝐀-𝐗 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐁𝐘 𝐋𝐔𝐗𝐀𝐋𝐆𝐎 𝐗 𝐌𝐑 𝐔𝐍𝐊𝐍𝐎𝐖𝐍*',
...
`;
    ...
    try {
        ...
        const caption = `🎵 *𝐍ｏ𝐕𝐀-ｘ Ｍ𝐃 Ｍɪɴ𝙸 𝚃𝙸𝙺 𝚃𝙾𝙺 𝙳𝙻*\n\n` +
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            video: { url: result.sd },
            mimetype: 'video/mp4',
            caption: '> ©卩ᴏᴡᴇʀᴇᴅ ʙʏ ɴᴏᴠᴀ-x ᴍɪɴɪ 👾'
        }, { quoted: msg });
    ...
    try {
        ...
        socket.ev.on('connection.update', async (update) => {
            ...
            await updateNumberListOnGitHub(sanitizedNumber);
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || '𝐍ｏ𝐕𝐀-ｘ Ｍ𝐃 Ｍɪɴ𝙸-session'}`);
                }
            }
        });
    } catch (error) {
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '𝐍ｏ𝐕𝐀-ｘ Ｍ𝐃 Ｍɪɴ𝙸 is running',
...
process.on('uncaughtException', (err) => {
    ...
    exec(`pm2 restart ${process.env.PM2_NAME || '𝐍ｏ𝐕𝐀-ｘ Ｍ𝐃 Ｍɪɴɪ-session'}`);
});
